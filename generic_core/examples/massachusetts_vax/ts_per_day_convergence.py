...
Run from the repo root:
    uv run python generic_core/examples/massachusetts_vax/ts_per_day_convergence.py
    uv run python generic_core/examples/massachusetts_vax/ts_per_day_convergence.py --ts-per-day 7 14 28 56
"""
...
def _load_config() -> dict:
    with open(os.path.join(HERE, "model_config_MA.json")) as f:
        return json.load(f)

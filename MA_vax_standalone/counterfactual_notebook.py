"""
  marimo run MA_vax_standalone/counterfactual_notebook.py
"""
...
def _(mo):
    ...
    `MA_vax_standalone/counterfactual.py` (`single_age_only_scenario`,
...
def _(mo):
    results_folder = mo.ui.text(
        value="MA_vax_standalone/counterfactual_tables_det",
        placeholder="MA_vax_standalone/counterfactual_tables_det",
...
def _(mo):
    ...
    `MA_vax_standalone/counterfactual.py`:

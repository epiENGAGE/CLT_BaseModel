...
Run:
    uv run python MA_vax_standalone/fit_bayesian.py --method both            # with m(t)
    uv run python MA_vax_standalone/fit_bayesian.py --method both --age-specific-ihr  # with m(t), ihr scaling per age group
    uv run python MA_vax_standalone/fit_bayesian.py --method both --no-tvbeta
    uv run python MA_vax_standalone/fit_bayesian.py --method emcee --age-specific-ihr
    uv run python MA_vax_standalone/fit_bayesian.py --method emcee --age-specific-ihr --no-tvbeta

Outputs figures + a parameter table into MA_vax_standalone/.
"""

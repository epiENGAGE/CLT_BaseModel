"""
Next-generation-matrix (NGM) reproduction-number analysis for MA_vax_standalone.
...
def load_default_base_inputs():
    return cf.load_base_inputs(
        fit_folder="MA_vax_standalone/outputs_2026-07-30_age_ihr_scale",
...
if __name__ == "__main__":
    ...
    df.to_csv("MA_vax_standalone/R_timeseries.csv")
    print("\nTime-varying R0(t)/Reff(t) written to MA_vax_standalone/R_timeseries.csv")

...
Loads a fitted parameter set from a MA_vax/fit_bayesian.py output folder
...
Run from the repo root:
    uv run python MA_vax/compare_to_generic.py
    uv run python MA_vax/compare_to_generic.py --output-folder MA_vax/outputs_2026-07-30_age_ihr_scale
"""
...
from MA_vax.fit_bayesian import load_fitted_run

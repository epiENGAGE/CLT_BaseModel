...
see `MA_vax/counterfactual.py`) and save them to CSV.
...
Run:
    uv run python MA_vax/run_counterfactual_tables.py --n-reps 1000 --point best
    uv run python MA_vax/run_counterfactual_tables.py \
        --fit-folder MA_vax/outputs_2026-07-29 --method emcee --n-reps 500 --point best
    uv run python MA_vax/run_counterfactual_tables.py --method emcee --fit-folder MA_vax/outputs_2026-07-30 --deterministic --out MA_vax/counterfactual_tables_det --point best
    uv run python MA_vax/run_counterfactual_tables.py --method emcee --fit-folder MA_vax/outputs_2026-07-30_age_ihr_scale --deterministic --out MA_vax/counterfactual_tables_det_age_ihr_scale --point best
    uv run python MA_vax/run_counterfactual_tables.py --method emcee --fit-folder MA_vax/outputs_2026-07-30_age_ihr_scale_no_V_infec --deterministic --out MA_vax/counterfactual_tables_det_age_ihr_scale_no_V_infec --point best
...
def main():
    ...
    ap.add_argument("--out", default=None,
                     help="output folder [default: MA_vax/counterfactual_tables_<timestamp>]")
    args = ap.parse_args()

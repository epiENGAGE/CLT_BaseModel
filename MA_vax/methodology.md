...
MCMC (`emcee`). This document describes the model in `MA_vax/model.py`, the
fitting procedure in `MA_vax/fit_bayesian.py`, and the calibrated parameters
from the run in `MA_vax/outputs_2026-07-30_age_ihr_scale_no_V_infec/`.
...
`MA_vax/outputs_2026-07-30_age_ihr_scale/` for comparison.
